...
public class CellularAutomata {
    ...
    //Método usado na app para definir o array das imagens do terreno
    public void setStateImgs(PImage[] imgs) {
    	this.imgs = imgs;
    }

    public PImage[] getStateImgs() {
        return this.imgs;
    }
    ...
    public void initRandomCostom(double[] pmf) {
