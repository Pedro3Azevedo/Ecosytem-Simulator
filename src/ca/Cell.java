...
public class Cell {
    ...
    //É feito o display dos states com o array das imagens disponivel na instancia CellularAutomata
    public void display(PApplet p){
    	p.pushStyle();
    	p.noStroke();
    	//p.fill(ca.getStateColors()[state]);
    	//p.rect(ca.xmin+col*ca.cellWidth, ca.ymin+row* ca.cellHeight,ca.cellWidth, ca.cellHeight);
    	p.image(ca.getStateImgs()[state], ca.xmin+col*ca.cellWidth, ca.ymin+row* ca.cellHeight,ca.cellWidth, ca.cellHeight);
        p.popStyle();
    }
